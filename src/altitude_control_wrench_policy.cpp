...
void fugu_teleoperation::AltitudeControlWrenchPolicy::advertiseTopics()
{
  ...
  wrench_pub_ = nh_.advertise<geometry_msgs::WrenchStamped>("wrench_request", 10);
  bool latched = true;
  altitude_request_pub_ = nh_.advertise<std_msgs::Float32>("altitude_request", 1, latched);
